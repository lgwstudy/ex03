...
//	var bnoValue='<c:out value="${board.bno}" />';
	...
	var modalCloseBtn = $("#modalClosedBtn");

	// 댓글 쓰기 버튼을 클릭하면 modal창 띄움
	$("#addReplyBtn").on("click", function() {
		// alert("댓글쓰기");
		// 모달창의 input 태그의 값을 빈 문자열로 세팅
		modal.find("input").val("");
		// 모달창의 작성일자는 댓글을 작성할때 필요없으므로 숨김
		modalInputReplyDate.closest("div").hide();
		// 모달 창의 close 버튼을 제외하고 나머지 버튼은 숨김
	...
	modalMoBtn.on("click", function(e) {
		...
		replyService.update( // update 함수 호출 시작
				reply,
	...
	modalRemoveBtn.on("click", function(e) {
		...
		replyService.remove( // remove 함수 호출 시작
				rno,
				function(count) {	// callback 함수 호출 시작
					console.log(count);
